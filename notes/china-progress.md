...
**Score after round 41 — provinces: 8 wired · 7 node-but-unwired · 15 no node yet · 2 blocked** (unchanged by rounds 40 and 41, which deepened yearbooks rather than adding one; Guangdong went 4 → 12 edges, Suzhou 0 → 3).
