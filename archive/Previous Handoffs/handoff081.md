...
- **`iq-cso`/`ye-cso`/`sy-cbs`/`sd-cbs` — PARKED, ruled 2026-09-09.** Legitimate but currently
  unwireable; not duplicates, not to be retired. Do not re-hunt them — the rule and the reasoning
  are in `playbook/corpus-nodes.md`, and `iq-cso`'s separate possible-duplicate question stays open.

## 3. Todo (live items only)

### [Thomas]

**1. `MEMORY.md` — DONE, 2026-09-09.** Condensed **63.9 KB → 30.1 KB** (53% smaller) and every
missing index line added: **133 of 135 topic files are now linked**, up from 107, and the two that
are not (`grok_archive_state.md`, `project_protocol.md`) are the retired pair the header names as
do-not-read. The 09-06/07/08 sections were the whole problem — 48.7 KB of the 63.9, with entries
running 1–3 KB against this file's own ~150-char bar; everything from 09-05 back was already in
spec and was left alone. Longest entry now 573 chars, was 3,092. Backup of the pre-condense index
is `archive/MEMORY-backup-2026-09-09.md`, and the stored copy was read back and checked against
the intended text before this line was written. Nothing left here — this item leaves at the next
handoff.
